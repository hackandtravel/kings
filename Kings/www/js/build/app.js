...
var AppView = React.createClass({displayName: 'AppView',
  ...
  render: function () {
    ...
    return (
      React.DOM.div( {id:"perspective", onTouchStart:this.touchStart, onTouchMove:this.touchMove, onTouchEnd:this.touchEnd, onTouchCancel:this.touchEnd, onTouchLeave:this.touchEnd}, 
    ...
    return (
      React.DOM.div( {className:classes}, 
        ...
        React.DOM.div( {className:"opacity"}, 
          ...
          React.DOM.div( {className:"rotate"}, 
            React.DOM.h1(null, 
              this.beerify(card.title),
              React.DOM.span( {className:"card"}, 
                React.DOM.span( {className:"color", dangerouslySetInnerHTML:{__html: card.type}} ),
...
React.renderComponent(AppView(null ), document.getElementById("body"));
